...
const { jwtSecret, jwtExpiresIn, refreshSecret, refreshExpiresIn } =
  getJwtConfig();
...
/**
 * Generate JWT access token for scanLogin with 3-minute expiry
 */
export const generateScanLoginToken = (payload: TokenPayload): string => {
  const options: SignOptions = {
    expiresIn: "30m",
    algorithm: "HS256",
  };
...
export const sanitizedCompany = (data: string | undefined | null): string => {
